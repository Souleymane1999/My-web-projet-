...
describe('Transfert Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'transfert', component: TransfertComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.transferts?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to transfertService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getTransfertIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getTransfertIdentifier).toHaveBeenCalledWith(entity);
