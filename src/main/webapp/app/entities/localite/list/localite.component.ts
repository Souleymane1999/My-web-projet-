...
import { EntityArrayResponseType, LocaliteService } from '../service/localite.service';
...
export class LocaliteComponent implements OnInit {
  ...
  trackId = (_index: number, item: ILocalite): number => this.localiteService.getLocaliteIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.localites = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: ILocalite[] | null): ILocalite[] {
    return data ?? [];
  }
  ...
  protected queryBackend(page?: number, predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.localiteService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
