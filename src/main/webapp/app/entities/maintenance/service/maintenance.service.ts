...
type RestOf<T extends IMaintenance | NewMaintenance> = Omit<T, 'dateMaintenance'> & {
...
export class MaintenanceService {
  ...
  protected convertDateFromClient<T extends IMaintenance | NewMaintenance | PartialUpdateMaintenance>(maintenance: T): RestOf<T> {
    return {
      ...maintenance,
      dateMaintenance: maintenance.dateMaintenance?.toJSON() ?? null,
    };
  }
  ...
  protected convertDateFromServer(restMaintenance: RestMaintenance): IMaintenance {
    return {
      ...restMaintenance,
      dateMaintenance: restMaintenance.dateMaintenance ? dayjs(restMaintenance.dateMaintenance) : undefined,
    };
  }
