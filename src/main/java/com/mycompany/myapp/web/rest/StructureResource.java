...
public class StructureResource {
    ...
    public ResponseEntity<StructureDTO> updateStructure(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, structureDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<StructureDTO> partialUpdateStructure(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, structureDTO.getId().toString())
        );
    }
    ...
    public ResponseEntity<List<StructureDTO>> getAllStructures(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
