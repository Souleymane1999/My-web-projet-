...
import localiteResolve from './localite-routing-resolve.service';

describe('Localite routing resolve service', () => {
  let mockRouter: Router;
  let mockActivatedRouteSnapshot: ActivatedRouteSnapshot;
  let service: LocaliteService;
  let resultLocalite: ILocalite | null | undefined;
  ...
  describe('resolve', () => {
    it('should return ILocalite returned by find', () => {
      ...
      TestBed.runInInjectionContext(() => {
        localiteResolve(mockActivatedRouteSnapshot).subscribe({
          next(result) {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultLocalite).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<ILocalite>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
