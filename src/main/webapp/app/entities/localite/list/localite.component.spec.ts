...
describe('Localite Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'localite', component: LocaliteComponent }]),
  ...
  describe('trackId', () => {
    it('Should forward to localiteService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getLocaliteIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getLocaliteIdentifier).toHaveBeenCalledWith(entity);
