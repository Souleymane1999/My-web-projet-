...
public class MaintenanceResource {
    ...
    public ResponseEntity<List<MaintenanceDTO>> getAllMaintenances(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
        log.debug("REST request to get a page of Maintenances");
        Page<MaintenanceDTO> page = maintenanceService.findAll(pageable);
